...
GO
-- Tabla DETALLE_NOMINA
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'ISR_ACUMULADO')
BEGIN

CREATE TABLE ISR_ACUMULADO(
ID INT IDENTITY(1,1) PRIMARY KEY,
CODIGO_EMP NVARCHAR(40),
NOMBRE_EMP NVARCHAR(100),
SUELDO DECIMAL(12,2),
ACUMULADO_MES DECIMAL(12,2),
CANT_NOM_MES DECIMAL(12,2),
FECHA DATETIME2(6)
);
